...
namespace api
{
    class RandomProperty
    {
        ...
        private List<string> brand_list = new List<string>() 
        { 
        "Fiat", "Nissan", "Toyota", "Mitsubishi", "Bmw", "Audi", "Mercedes", "Volkswagen", "Opel", "Mazda",
        ...
        {
            "Black", "White", "Red", "Pink", "Green", "Gray", "Gold", "Silver", "Coral", "Navy", "Amber", "Azure",
